...
public class BotParser {
	...
	final Scanner scan;
	final BotStarterInterface bot;

	private Field mField;
	public static int mBotId = 0;
	public static int mOpponentId = 0;

	public BotParser(BotStarterInterface bot) {
		...
		while (scan.hasNextLine()) {
			...
			if (parts[0].equals("settings")) {
				...
				if (parts[1].equals("move")) {
					...
					if (move != null) {
						System.out.println("place_move " + move.getCol() + " "
								+ move.getRow());
					} else {
