...
public class UltimateTicTacToe extends AbstractGame {
	...
	public void setupGame(ArrayList<IOPlayer> ioPlayers) throws Exception {
		...
		for (int i = 0; i < ioPlayers.size(); i++) {
			...
			Player player = new Player(playerName, ioPlayers.get(i),
					TIMEBANK_MAX, TIME_PER_MOVE, i + 1);
	...
	public void sendSettings(AbstractPlayer player) {
		...
		player.sendSetting("player_names", this.players.get(0).getName()
	...
	public static void main(String args[]) throws Exception {
		...
		// exporting data
		UltimateTicTacToe.EXPORT_DIRECTORY = "."
				+ File.separator + "Viewer" + File.separator + "data"
				+ File.separator;
